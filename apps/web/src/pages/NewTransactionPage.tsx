...
export function NewTransactionPage() {
  ...
  return (
    <section className="space-y-4">
      ...
      {error ? <p className="rounded-md bg-amber-500/15 px-3 py-2 text-amber-200">{error}</p> : null}

      <form className="space-y-4 rounded-lg glass-panel p-4 shadow-lg shadow-amber-500/5 card-animate" onSubmit={onSubmit}>
        <div className="grid gap-3 md:grid-cols-2">
          <label className="min-w-0 text-sm text-gray-200">
            ...
            <input
              required
              type="date"
              className="gold-focus mt-1 block w-full min-w-0 rounded-md border border-amber-300/35 bg-gray-900/80 px-3 py-2"
              value={date}
          ...
          <label className="min-w-0 text-sm text-gray-200">
            類型
            <select
              className="gold-focus mt-1 block w-full min-w-0 appearance-none rounded-md border border-amber-300/35 bg-gray-900/80 px-3 py-2"
              value={type}
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className="gold-focus w-full rounded-md border border-amber-300/35 bg-gray-900/80 px-3 py-2"
            value={customTags}
        ...
        <button
          type="submit"
          className="rounded-md bg-amber-400 px-4 py-2 font-medium text-gray-900 shadow-lg shadow-amber-400/20 transition duration-200 hover:-translate-y-0.5 hover:bg-amber-300"
        >
          建立交易
        </button>
      </form>
